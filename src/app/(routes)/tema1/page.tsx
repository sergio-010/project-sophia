...
const Dislexia = () => {
    ...
    return (
        <div className=" flex flex-col p-8 justify-center from-purple-200 via-purple-300 to-purple-500 bg-gradient-to-br ">
            <button className="w-10font-bold leading-tight text-center md:text-4xl md:mb-5" onClick={() => router.push("/")}>🏠</button>
